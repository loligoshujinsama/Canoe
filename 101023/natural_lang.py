...
def initiateNLP(dict):
    df = pda.DataFrame(pad_list(fetchAirlineReview(dict)[0]))
    unique_airlines = fetchAirlineReview(dict)[1]
    emotion_dict = {}
    
    # get the emotion dictionary ready
    emotion_file = open(r"C:\Users\brand\PycharmProjects\pythonProject\091023\091023\emotion.txt",'r',encoding='utf-8')
    ...
    for airline_name in unique_airlines:
        ...
        try:
            ...
            plt.axis('off') 
            plt.savefig(f'{airline_name}.png', dpi=300, bbox_inches='tight')
