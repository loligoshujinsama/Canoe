...
# MONTH_DICTIONARY = {1: 'Jan', 2: 'Feb', 3: 'Mar', 4: 'Apr', 5: 'May', 6: 'Jun', 7: 'Jul', 8: 'Aug', 9: 'Sep', 10: 'Oct',
#                     11: 'Nov', 12: 'Dec'}
...
def read_excel_file(dataframe):
    ...
    return dataframe.groupby('Airline')['Price'].apply(custom_median).reset_index()
...
def bargraph(df, cheap, expensive):
    ...
    fig.write_html(r"C:\Users\brand\PycharmProjects\pythonProject\091023\091023\static\bar_graphtest.html")
...
def plot_bargraph(data):
    ...
    data_frame = read_excel_file(data)
